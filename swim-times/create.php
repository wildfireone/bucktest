...
if (isset($_POST['btnSubmit'])) {
    ...
    if ($swim->isInputValid($_POST["sltGala"], $_POST["sltEvent"], $_POST["sltMember"], $_POST["txtTime"], $_POST["sltRank"])) {
        ...
        //Check if there no duplicate entries
        if ($swim->isSwimTimeUnique($connection)) {
...
<div class="row" id="content">
    <div class="large-12 medium-12 small-12 columns">
        ...
        <ul class="breadcrumbs">
            ...
            <li><a <?php echo 'href="../gala-results/view.php?id=' . $_GET["galaID"] . '"'; ?> role="link">Swim
                    Times</a></li>
        ...
        if (isset($_SESSION['copies'])) {
            echo '<p class="alert-box error radius centre">This swim time already exists. Please try again.</p>';
