...
<head>    
    ...
    <title>Gala Results | Galas | Bucksburn Amateur Swimming Club</title>    
    ...
    <div class="row" id="content">
        <div class="large-12 medium-12 small-12 columns">
            ...
            <ul class="breadcrumbs">
                ...
                <?php if(isset($_SESSION["username"])) { echo '<li><a href="galas.php" role="link">Galas</a></li>'; } ?>
                <li class="current">Gala Results</li>
            </ul>
            ...
            <?php
                ...
                $galasList = $galaItem->listAllCompletedGalas($conn);
                ...
                if (count($galasList) > 0 ) {
                    ...
                    echo '<tr><td colspan="5" class="centre">No completed galas were found.</td></tr>';
                }
                dbClose($conn);
            ?>
