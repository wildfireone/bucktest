...
<head>    
    ...
    <title>Create | Timetable | Bucksburn Amatuer Swimming Club</title>  
    ...
    <div class="row" id="content">
        <div class="large-12 medium-12 small-12 columns">
            ...
            <ul class="breadcrumbs">
                ...
                <li class="current">Create a Timetable Item</li>
            </ul>
    
            <h2>Create a Timetable Item</h2>
            ...
            <?php
                ...
                if (isset($_POST["btnSubmit"])) {
                    ...
                    echo comboInputBlank(true,"Day","sltDay","Please select a Day...",$day->listAll($conn));
                }
                ...
                if (isset($_POST["btnSubmit"])) {
                    ...
                    echo comboInputBlank(true,"Venue","sltVenue","Please select a Venue...",$venue->listAllVenues($conn));
                }
                ...
                if (isset($_POST["btnSubmit"])) {
                    ...
                    echo textInputBlank(true,"Time","txtTime",11);
                }
                ...
                if (isset($_POST["btnSubmit"])) {
                    ...
                    echo checkboxInputBlank(true,"Squads","chkSquads",$squad->listAllSquads($conn));
                }

                echo formEndWithButton("Add Timetable Item");
